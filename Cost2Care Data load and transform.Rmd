...
```{r Add the weughts to the data files}
##############################################################
...
```{r Save the files}
# Site review + HIPE
saveRDS(Cost2Care.HIPE,
        file = "data/transformed_data/Cost2Care.HIPE.Rds",
        ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

saveRDS(CTC.H,
        file = "data/transformed_data/CTC.H.Rds",
        ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

# HIPE for country
saveRDS(HIPE,
        file = "data/transformed_data/HIPE.Rds",
        ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

saveRDS(H.N,
        file = "data/transformed_data/H.N.Rds",
        ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

# HIPE for site data only
saveRDS(HIPE.Site,
        file = "data/transformed_data/HIPE.Site.Rds",
        ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

saveRDS(H.S,
        file = "data/transformed_data/H.S.Rds",
        ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)
