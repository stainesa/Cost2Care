...
```{r AddDRG complexity codes to the two files}
...
We omit records where the outcome is missing - these are the two discussed previously. We leave out date records, text descriptions, and the variable 'rawlos' (which is another version of the outcome variable!) 
...
saveRDS(C2C.H, file = "data/C2C.H.Rds",
        ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)
