...
Next we check and merge the Chart Review data, and the corresponding HIPE.Site data for those cases. These are the selected weighted sample of cases from one large Model 4 hospital.
