...
HIPE.Predicted <- readRDS(file = 'data/Predictions_PN.Rds') |>
  select(c(rowid,Q10:Outcome, V1:V4000)) |>
...
kable(Summary.HIPE, caption = 'Summary of modelled predictions from TEST data for chart review HIPE')

ggplot(HIPE.Predicted,
       aes(y = 0, x = Q50, colour = Outcome)) +
  geom_violin() +
