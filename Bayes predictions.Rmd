...
Summary.CHART <- CCH |>
  ...
  pivot_longer(cols = everything(),
               ...
               values_to = 'Observed') |>
  group_by(Outcome) |>
  summarise(across(Observed, list(mean = mean, median = median, sd = sd))) # 5 values
...
Summary.TRAIN <- TRAIN_Predicted |>
  ...
  group_by(Outcome) |>
  summarise(across(.prediction, list(mean = mean, median = median, sd = sd))) # 10 values
...
```{r Plot of predictions}

ggplot(TRAIN_Predicted,
