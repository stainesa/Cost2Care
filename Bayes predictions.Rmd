...
G_TRAIN_Predicted = ggplot(TRAIN_Predicted,
  ...
  facet_wrap( ~Outcome )
G_TRAIN_Predicted
ggsave('image/G_TRAIN_Predicted.pdf', G_TRAIN_Predicted, units = 'cm', height = 10, width = 10)
...
G_TEST_Predicted = ggplot(TEST_Predicted,
  ...
  facet_wrap( ~Outcome ) 
G_TEST_Predicted
ggsave('image/G_TEST_Predicted.pdf', G_TEST_Predicted, units = 'cm', height = 10, width = 10)
rm(G_TEST_Predicted)
```
...
HIPE.PNk <- HIPE.PNk |>
  add_epred_draws(object = fit.PNk) # Probabilities
