...
PI_plot <- ggplot(data=Chart, aes(x = Outcomes, y = PI_Estimate)) +
  geom_point(colour = 'red', size = 4) +
...
```{r Point estimates and 0.95 prediction and confidence intervals for each outcome in the chart review data, fig.cap= 'Point estimates and 95% prediction intervals for each outcome in the chart review data.', fig.dpi=1200, fig.height=5, fig.width=7}
