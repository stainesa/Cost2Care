...
```{r Load data}
C2C.H <- readRDS(file = "data/transformed_data/CTC.H.Rds") %>%
...
```{r calculate CI}
CI <- Hmisc::binconf(Chart$Cases,
                     Chart$Total,
                     include.x = TRUE,
                     include.n = TRUE) 
# Calculate default Wilson CI's - A. Agresti and B.A. Coull, Approximate is better than "exact" for interval estimation of binomial proportions, American Statistician, 52:119–126, 1998.
