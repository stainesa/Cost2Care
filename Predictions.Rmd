...
After testing a number of values - 5, 3, and 2.5, we elect to trim off at a scaled length of stay of 3. This is 76 days, and at the 98th percentile of lengths of stay. This drops nine observations from the site dataset

```{r Set the cutofff value at 3}
TRIM_LosC = 3
```
...
lrn_R_mbo$train(tsk_C.trim, split$train)
prediction = lrn_R_mbo$predict(tsk_C.trim, split$test)
