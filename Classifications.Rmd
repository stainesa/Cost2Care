...
#PN
  flt_Imp$calculate(tsk_PN)
    ...
    keep = names(which(flt_Imp$scores >
                         (max(flt_Imp$scores)/10) & (flt_Imp$scores > 0.0015)))
...
In pretty much every example, an mtry of between 3 and 5 is optimal. Note that while the scale of some of the graphs suggest very little effect of mtry, in that some of the parameters change little for any value of mtry studied.
