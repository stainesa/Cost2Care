...
There are two records in the HIPE file, with StudydIds 41 and 405, which are correctly omitted from the chart review. We remove these now.

```{r remove surplus records 41 and 405}
