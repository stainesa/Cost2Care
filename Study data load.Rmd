...
summarytools::dfSummary(Cost2Care.HIPE)
```
...
table(Cost2Care.HIPE$gender,
      Cost2Care.HIPE$sex,
      useNA = 'ifany')
# Oops
table(Cost2Care.HIPE$age_discharge,
      Cost2Care.HIPE$age) # Mostly ok, but a few large discrepancies
...
* the presence of a health care associated urinary tract infection (UTI - variable beginning with 'U.')
* the presence of health care associated pneumonia (PN - variable beginning with 'P.')
