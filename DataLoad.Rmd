...
First we load the data, and then keep 1/5 of the rows for testing, leaving 4/5 for training [@ashley_etal15].

and [@aalbers_christophers14] njmnm
...
#Then we split
DATA_split <- initial_split(DATA, prop = 4/5, strata = hosp_anon)
...
# Add a variable to indicate training set or test set.
 DATA$Training[DATA_split$in_id] <- TRUE
