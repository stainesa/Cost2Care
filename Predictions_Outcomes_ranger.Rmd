...
L1_test <- L1$predict_newdata(newdata = as_tibble(tsk_Outcome$filter(split_Outcome$test)$data()),
                      task = tsk_Outcome)
L1$predict_newdata(newdata = as_tibble(tsk_Outcome$filter(split_Outcome$test)$data()),
                      task = tsk_Outcome)
